...
class Experiment():
    ...
    def run_batch_episodes(self, 
        ...
        for i_episode in range(num_episodes):
            ...
            with open(self.results_dir+"myLogFile.txt", 'a') as txtFile:
                txtFile.write(f'Rodou episodio {self.episode_title} {i_episode} com disturber{self.environment.distuber_index} em {end_time-start_time:.2f}s / recompensa: {episode_total_discounted_reward:.1f}\n')# mudanca Nova!!!-----------------------------------------------------------
