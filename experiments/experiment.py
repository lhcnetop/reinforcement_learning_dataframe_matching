...
from disturb.disturber_map import disturber_map
...
class Experiment():
    ...
    def run_batch_episodes(self,
        ...
        for i_episode in range(num_episodes):
            ...
            end_time=time.time()
            print(f'Rodou episodio {self.episode_title} {i_episode} em {end_time-start_time:.2f}s / recompensa: {episode_total_discounted_reward:.1f}')
    ...
    def from_json(json_file_path:str):
        ...
        with open(json_file_path) as json_file:
            ...
            experiment=Experiment(
                ...
                disturb_function=disturber_map[json_spec['disturb_function']],
